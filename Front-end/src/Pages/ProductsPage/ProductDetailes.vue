...
<template>
  ...
  <div class="mt-5 bg-gray-200 text-gray-00">
    <button class="py-4 px-10">
      <RouterLink :to="{ name: 'Mobile' }">
      ...
      <div class="md:col-span-4 col-span-12" id="font">
        ...
        >
          <div class="flex gap-2 border">
            ...
            <h2 class="my-auto">
              Name :
              <span class="text-blue-500"> {{ product.product?.user?.name }} </span>
            </h2>
          </div>
          <div class="border mt-5 p-2">
            ...
            <h2 class="my-auto mb-2">
              Description :
              <span class="text-blue-500">{{ product.product?.description }}</span>
            </h2>
          </div>
              ...
              <div class="flex justify-center">
                <button @click="clickefav(product.product.id)">
                  <svg
                    ...
                    class="w-6 h-6"
                    :class="
                      product.product?.is_favorite ? 'text-red-500' : 'text-black'
                    "
                  >
                    <path
