...
<template>
  ...
  <div v-else>
            ...
            <carousel :items-to-show="1">
              ...
              >
                <img
                  :src="image"
                  alt=""
                  class="rounded w-full h-[500px] object-cover"
                />
              </slide>
          ...
          <div class="p-5 rounded border border-gray-300">
            ...
            <div class="border mt-5" v-else-if="!auth.userInfo?.user?.id">
              <RouterLink :to="{ name: 'Login' }">
                <div
                  class="grid grid-cols-1 bg-gray-500 text-sm text-white p-2"
                >
            ...
            <div
              class="border mt-5"
              v-else-if="auth.userInfo?.user?.role === 'admin'"
            >
              <div class="flex justify-center bg-red-500 text-white p-2">
                <button
                  @click="deleteProductItem(product.product.id)"
                  class="w-full"
                >
                  Delete Product
                </button>
            ...
            <div class="border mt-5 p-2" v-else>
              <div class="grid grid-cols-4">
                ...
                <div class="flex justify-center">
                  <button
                    @click="clickReport(product.product.id)"
    ...
    />
    <ProductReport
      v-if="isReportModal && !currentUserReport"
