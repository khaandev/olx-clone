...
const props = defineProps(['label', 'modelValue', 'placeholder', 'type', 'disabled'])
...
<template>
  <div id="input" class="flex flex-col w-full">
    <label for="username" class="block text-gray-600">{{ label }}</label>
    <input
