...
<template>
  <div
    class="bg-white p-2 absolute w-[280px]  md:w-[200px] top-14 md:right-0  rounded-md shadow-lg"
  >
    <div class="my-2">
    ...
    <hr />
    <ul class="my-3 grid grid-cols-2 md:grid-cols-1 md:gap-0 gap-3" v-if="auth.userInfo?.user?.role === 'user'">
      <li
